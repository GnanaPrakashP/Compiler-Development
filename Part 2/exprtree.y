%{
     ...
     char class_data_type[30];
     int object_flag=0;
     struct tnode *offset_ptr=NULL;
...
%token CLASS ENDCLASS SELF NEW EXTENDS DELETE
...
Cname : ID                                                          {
      ...
      | ID EXTENDS ID                                               {
                                                                        cinstall($<ptr>1->varname,$<ptr>3->varname);
                                                                        strcpy(class_name,$<ptr>1->varname);
                                                                        update_field_func($<ptr>3->varname);
                                                                        $<ptr>$=$<ptr>1;
                                                                    }
      ;
...
Gid : ID                                                            {
                                                                        if(clookup(class_data_type)!=NULL){
                                                                            ginstall($<ptr>1->varname,2);
                                                                        }
                                                                        else{
...
Fdef : Type X3 '(' Y ')' '{' LdeclBlock '}'                         {
                                                                        if(class_flag){
                                                                            ...
                                                                            generate_code($<ptr>7,fptr,getlabel($<ptr>2->varname,clookup(class_name)));
                                                                        }
                                                                        else{
...
Type : INT                                                          {
     ...
     | ID                                                           {
                                                                        ...
                                                                        class_data_type[0]='\0';
                                                                        strcpy(class_data_type,$<ptr>1->varname);
                                                                        classtable_temp=clookup($<ptr>1->varname);
                                                                    }
     ;
